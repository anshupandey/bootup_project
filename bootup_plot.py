...
def generate_barplot(basic_score,advance_score,overall=False,name=None):
  plt.figure(figsize=(18,10))
  domains=['Python Programming', 'Data Science', 'Machine Learning',"Deep Learning"]
  ...
  for bar,eb in zip(bars2,bars):
    plt.gca().text(bar.get_x() + bar.get_width()/2, bar.get_height()-1+eb.get_height(), str(int(bar.get_height())), 
                 ha='center', color='w', fontsize=22)
